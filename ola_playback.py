...
def main(audio_name, delay=1, universe=1, start_at_sec=0.0):
    config = load_config()
    ...
    queueservice.play_ola_show(audio_name, delay, universe, start_at_sec=start_at_sec)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-s", "--start", type=float, default=0.0, help="Start time in seconds for playback (default: 0.0 sec)")
    args = parser.parse_args()
    main(args.audio_name, delay=args.delay, universe=args.universe, start_at_sec=args.start)