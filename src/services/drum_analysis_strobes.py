...
def get_onset_parts(segments=None, input=None, sr=None):
    """Uses onset detection to find ranges where there are frequent drum hits for strobes"""
    print("--------Detecting onsets for strobe parts")
    ...
    print(f"--------Found {len(fused_onsets)} strobe parts")
    return fused_onsets
